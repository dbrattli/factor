        ...
        fun downstream ->
            let pid =
                Process.spawnLinked (fun () ->
                        ...
                        fun (inner: Factor<'T>) (retriesLeft: int) ->
                            ...
                            let childPid =
                                Process.spawnLinked (fun () ->
                                    ...
                                    let innerSelf: Observer<'T> = { Pid = Process.selfPid (); Ref = innerRef }
                    ...
                    let outerSelf: Observer<Factor<'T>> = { Pid = Process.selfPid (); Ref = outerRef }
